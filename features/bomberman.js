...
function startGame() {
    ...
    for (let r = 0; r < rows; r++) {
        ...
        for (let c = 0; c < columns; c++) {
            ...
            tile.src = "/assets/icons/" + randomBomb() + "-bomb.png";
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns-2; c++) {
            ...
            if (bomb1.src == bomb2.src && bomb2.src == bomb3.src && !bomb1.src.includes("background-tile")) {
                bomb1.src = "/assets/icons/blank.png";
                bomb2.src = "/assets/icons/blank.png";
                bomb3.src = "/assets/icons/blank.png";
                if (flag) {
                    score += 30;
                }
            }
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns-3; c++) {
            ...
            if (bomb1.src == bomb2.src && bomb2.src == bomb3.src && !bomb1.src.includes("blank")) {
                ...
                bomb2.src = "/assets/icons/blank.png";
                bomb3.src = "/assets/icons/blank.png";
                bomb4.src = "/assets/icons/blank.png";
                if (flag) {
                    score += 50;
                }
            }
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns-4; c++) {
            ...
            if (bomb1.src == bomb2.src && bomb2.src == bomb3.src && bomb3.src == bomb4.src && bomb4.src == bomb5.src && !bomb1.src.includes("blank")) {
                ...
                bomb3.src = "/assets/icons/blank.png";
                bomb4.src = "/assets/icons/blank.png";
                bomb5.src = "/assets/icons/blank.png";
                if (flag) {
                    score += 100;
                }
            }
...
function slideBombs() {
    for (let c = 0; c < columns; c++) {
        ...
        for (let r = ind; r >= 0; r--) {
            board[r][c].src = "/assets/icons/blank.png";
        }
    }
}
...
function generateBombs() {
    for (let c = 0; c < columns; c++)  {
        if (board[0][c].src.includes("blank")) {
            board[0][c].src = "/assets/icons/" + randomBomb() + "-bomb.png";
        }
    }
}
